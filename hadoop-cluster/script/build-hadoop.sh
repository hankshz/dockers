...
cp /raw/mapred-site.xml $HADOOP_BUILD/etc/hadoop/mapred-site.xml
cp /raw/yarn-site.xml $HADOOP_BUILD/etc/hadoop/yarn-site.xml
cp /raw/slaves $HADOOP_BUILD/etc/hadoop/slaves
